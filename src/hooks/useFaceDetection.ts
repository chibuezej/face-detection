import { useCallback, useEffect, useRef, useState, LegacyRef, RefObject } from 'react';
import Webcam from 'react-webcam';
import { Results, NormalizedRect, Options, FaceDetection } from '@mediapipe/face_detection';
